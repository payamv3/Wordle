...
bars1 = alt.Chart(opener_df).mark_bar(cornerRadiusTopLeft=3,
    ...
    color=alt.condition(
        ...
        alt.value('purple'),     # which sets the bar orange.
...
heatmap = alt.Chart(df).mark_rect().encode(
    ...
    alt.Color('count():Q', scale=alt.Scale(scheme='purple'), legend = None)).properties(title = 'Correlation Between How Many Words I Get Right The First Time and The Number of Tries', width = 300, height = 400)
